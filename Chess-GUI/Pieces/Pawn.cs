...
namespace Chess_GUI
{
    public class Pawn : Piece
    {
        ...
        public Pawn(Player color, bool computer)
        {
            Color = color;
        ...
        {
            Pawn cp = new Pawn(Color, computer);
        ...
        {
            yield return new PawnPromotion(from, to, PieceType.King);
        ...
        private IEnumerable<Move> DiagonalMoves(Position from, Board board)
        {
            foreach (Direction dir in new Direction[] {Direction.West, Direction.East})
            {
                ...
                if(to == board.GetPawnSkip(Color.Opponent()))
                {
